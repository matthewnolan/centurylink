            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="div-left-welcome">
                        ...
                        <h2>CenturyLink<sup>&reg;</sup> Managed Office is an entirely new approach to your communication and IT.</h2>
                        <p class="font-gray-mormal lead">Managed Office provides your business with fundamental IT and communication infrastructure, plus a dedicated team to manage it, all for one flat rate per seat per month.</p>
                        <p class="lead">You focus on your business. We handle the technology that runs it.</p>
                    </div>
                </div>
                <div class="col-md-6">
                	<div class="hidden-xs">
                        ...
                        <div class="hspace"> 
                            <div id="layer-mdata-welcome">
                                <img src="images/data_server.png" alt="" class="img-responsive" />
                                <div class="text-layer-welcom" id="text-layer-mdata-welcom">
                                    <span class="font-green-mormal block"><strong>Managed DATA</strong></span>
                                    <p class="width140">Ethernet connection to the CenturyLink network</p>
                                </div>
                            </div>
                            ...
                            <div id="layer-mvoice-welcome">
                                ...
                                <div class="text-layer-welcom" id="text-layer-mvoice-welcom">
                                    <span class="font-green-mormal block"><strong>Managed VOICE</strong></span>
                                    <p class="width140">Hosted VoIP on the industry-leading Broadsoft<sup>&reg;</sup> platform</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mobi-device visible-xs">
                    	<div class="hspace">
                            <div class="mobi-bg-circle"></div>
                        </div>   
                        <div class="hspace"> 
                            <div id="mobi-layer-mdata-welcome">
                                <img src="images/mobi/data_server.png" alt="" class="img-responsive" />
                                <div class="text-layer-welcom" id="mobi-text-layer-mdata-welcom">
                                    <span class="font-green-mormal block"><strong>Managed DATA</strong></span>
                                    <p class="" style="width: 85px;">Ethernet connection to the CenturyLink network</p>
                                </div>
                            </div>
                            
                            <div id="mobi-layer-mapps-welcome">
                                <img src="images/mobi/computer.png" alt="" class="img-responsive" />
                                <div class="text-layer-welcom" id="mobi-text-layer-mapps-welcom">
                                    <span class="font-green-mormal block"><strong>Managed APPLICATIONS</strong></span>
                                    <p class="" style="width: 170px;">Cloud-based applications with advanced messaging and collaboration</p>
                                </div>
                            </div>
                            
                            <div id="mobi-layer-mvoice-welcome">
                                <img src="images/mobi/phone.png" alt="" class="img-responsive" />
                                <div class="text-layer-welcom" id="mobi-text-layer-mvoice-welcom">
                                    <span class="font-green-mormal block"><strong>Managed VOICE</strong></span>
                                    <p class="" style="width: 120px;">Hosted VoIP on the industry-leading Broadsoft<sup>&reg;</sup> platform</p>
                                </div>
                            </div>
                        </div>
                    </div>
    	...
    	<div class="row">
            <div class="col-xs-12 col-md-3">
                <div id="question-testimonial" class="font-green-mormal text-right">
                    <div class="text-center visible-xs"><strong>Want to see who else is benefiting from Managed Office?</strong></div>
                    <div class="text-right visible-lg"><strong>Want to see who else is benefiting from Managed Office?</strong></div>
                </div>
            </div>
            <div class="col-md-9">
            	<div class="row">
    	...
    	<div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <div class="visible-xs">
                	<img src="images/mobi/modifferent.png" alt="" class="img-responsive" /> 
                </div>
            </div>
        </div>
    </div>
  	...
  	<div class="row" style="padding-top: 40px;">
		<div class="col-md-6 col-md-push-6">
			<div id="div-left-modifferent">
				...
				<div class="font-gray-mormal"><strong>See how our products and services all work together to drive your business forward.</strong></div>
			</div>
		</div>
    	...
    	<div class="row" style="padding-bottom: 250px;">
			<div class="col-md-5">
				...
				<div id="div-left-mobusiness">
			        ...
			        <p class="font-gray-mormal"><strong>No matter what size your business is, Managed Office can add a lot of value and prepare you for the future.</strong></p>
			    </div>
		    </div>
    	...
    	<div class="row">
			<div class="col-md-6">
				...
				<div>
			        ...
			        <span class="font-gray-mormal"><b>The beauty of Managed Office is that you pay one fixed rate per seat per month. You dont have to buy, install or manage anything, and you get one invoice from one trusted provider. You can plan for the short term and the long term because our predictable pricing scales with your business.</b></span><br><br>
			        <b>Need questions answered?</b>
			        <span class="font-gray-mormal"><b>Schedule a meeting to learn more.</b></span><br><br>
