 ...
 <div class="space40 visible-sm visible-md"></div>
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div id="div-left-welcome">
                        ...
                        <div class="page-header">
                        	<h1>How do Managed <span class="font-green-mormal">APPLICATIONS</span> work within Managed Office?</h1>
                        </div>
                ...
                <div class="col-sm-6 col-md-6">
                	<div class="hidden-xs">
                    	...
                    	<img src="<?php echo ROOT_URL; ?>/images/picapps.png" alt="" class="img-responsive" />
                    </div>
                    <div class="visible-xs">
                    	<img src="<?php echo ROOT_URL; ?>/images/mobi/picapps.png" alt="" class="img-responsive" />
                    </div>
                </div>
            </div>
            <div class="space60 visible-lg"></div>
            <div class="nextpage visible-lg visible-md">
            	<a href="#what-app-are-included-within-managed-office" class="btscroll">
                    ...
                    <span>SHOW ME MORE APPLICATIONS SPECIFICS</span>
                </a>
            </div>