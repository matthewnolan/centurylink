...
<div class="space60 visible-sm visible-md"></div>
<div class="space40 visible-sm visible-md"></div>
            <div class="row">
                    ...
                    <div id="div-left-welcome">
                        ...
                        <p class="fs14b">
                            ...
                            <ul class="fs14b font-gray-mormal padleft15">
                            	<li>Anywhere availability with voice over IP or mobile access to every call</li>
                            	<li>Hosted VoIP using our Broadsoft Broadworks platform</li>
                            	<li>Polycom IP phones</li>
                            	<li>Unlimited local and on-net long-distance calls</li>
                            	<li>A package of off-net long-distance and toll-free minutes</li>
                            	<li>Online management of your users and their settings that is easy to change and easy to move</li>
            ...
            <div class="nextpage visible-lg visible-md">
            	<a href="#you-want-more-voice-specifics" class="btscroll">
                    ...
                    <span>SHOW ME MORE VOICE SPECIFICS</span>
                </a>
            </div>