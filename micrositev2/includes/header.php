            ...
            <div class="row">
                        ...
                        <nav class="navbar navbar-default hidden-xs" role="navigation">
                            ...
                            <div class="collapse navbar-collapse" id="mobi-nav-collapse">
                                <ul class="nav navbar-nav navbar-mainmenu">
                                  <li<?php if($uri == '' || $uri == 'index'){ echo ' class="active"'; }?>><a href="<?php echo ROOT_URL; ?>/">HOME</a></li>
                                  <li class="dropdown<?php if(in_array( $uri,array('data','apps','voice') )){ echo ' active'; }?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown">PRODUCT COMPONENTS <b class="caret"></b></a>
                                  		<ul class="dropdown-menu">
											...
											<li><a href="<?php echo ROOT_URL; ?>/managed-voice/">MANAGED VOICE</a>
                                            	<div class="lidesc">
                                                	<span class="desctext">We give you phones, a dial tone, and a wide range of advanced calling and messaging features.</span>
                                                </div>
                                            </li>
											<li><a href="<?php echo ROOT_URL; ?>/managed-applications/">MANAGED APPLICATIONS</a>
                                            	<div class="lidesc">
                                ...
                                <ul class="nav navbar-nav">
									<li class="active"><a href="<?php echo ROOT_URL; ?>/">HOME</a></li>
                                  	<li class="mid">
	                                  	...
	                                  	<ul>
											<li><a href="<?php echo ROOT_URL; ?>/managed-data/">MANAGED DATA</a></li>
											<li><a href="<?php echo ROOT_URL; ?>/managed-voice/">MANAGED VOICE</a></li>
											<li><a href="<?php echo ROOT_URL; ?>/managed-applications/">MANAGED APPLICATIONS</a></li>
	                                  	</ul>
                                  	</li>
                                  	<li class="last">
                                  		<div class="col-xs-6 phone"><a href="callto:800.850.9881"><i class="fa fa-phone"></i>  <span>800.850.9881</span></a></div>
                    ...
                    <div class="col-xs-0 col-sm-3 col-md-3 nonpaddingall">
                        <ul class="fa-ul hidden-xs">
                          <li><a href="callto:800.850.9881"><i class="fa-li fa fa-phone fa-lg"></i><span>800.850.9881</span></a></li>
