	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-4 col-sm-3 col-md-2">
				...
				<object data="images/logo.svg" width="141" height="30"
					type="image/svg+xml">
					<img src="images/logo.png" alt="CENTURYLINK" width="141"
						height="30" />
				</object>
			</div>
			<div class="col-xs-8 col-sm-6 col-md-5">
				<nav class="navbar navbar-default hidden-xs" role="navigation"> <!-- Brand and toggle get grouped for better mobile display -->
				...
				<div class="collapse navbar-collapse" id="mobi-nav-collapse">
					<ul class="nav navbar-nav navbar-mainmenu">
						...
						<li
							class="dropdown<?php if($uri == 'data' || $uri == 'voice' || $uri == 'apps'){ echo ' active'; }?>"><a
							href="#" class="dropdown-toggle" data-toggle="dropdown">PRODUCT
								COMPONENTS <b class="caret"></b> </a>
							<ul class="dropdown-menu">
								<li><a href="data.php">MANAGED DATA</a>
									<div class="lidesc">
										<span class="desctext">We manage your internet connection,
											virtual server, and data back-up.</span>
									</div>
								</li>
								...
								<li><a href="apps.php">MANAGED APPLICATIONS</a>
									<div class="lidesc">
										<span class="desctext">We provide and manager your business
				...
				<ul class="nav navbar-nav">
					...
					<li class="last">
						<div class="col-xs-6 phone">
							<a href="callto:800.361.0833"><i class="fa fa-phone"></i> <span>800.361.0833</span>
							</a>
						</div>
			...
			<div class="col-xs-0 col-sm-3 col-md-3 head-contact">
				<ul class="fa-ul hidden-xs">
					<li><a href="callto:800.361.0833"><i
							class="fa-li fa fa-phone fa-lg"></i><span>800.361.0833</span> </a>
					</li>
