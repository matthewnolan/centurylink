		...
		<div class="padding-fix">
			...
			<div class="row onboard3col">
				<div class="col-sm-4 ">
					...
					<div class="onboard-content new-business readmore">
						...
						<p><a href="<?php echo ROOT_URL;  ?>/download.php?fname=business-hosted-apps/Microsoft_Hosted_Exchange.pdf">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
					</div>
				</div>
				<div class="col-sm-4 ">
					...
					<div class="onboard-content new-business readmore">
						...
						<p><a href="<?php echo ROOT_URL;  ?>/download.php?fname=business-hosted-apps/Microsoft_Hosted_SharePoint.pdf">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
				...
				<div class="col-sm-4 ">
					...
					<div class="onboard-content new-business readmore">
						...
						<span class="3dot">...</span><div class="details"></div>
							...
							<p><a href="<?php echo ROOT_URL;  ?>/download.php?fname=business-hosted-apps/Microsoft_Hosted_Lync.pdf">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
			...
			<div class="row onboard3col">
				...
				<div class="onboard-content new-business readmore">
					...
					<p><a href="<?php echo ROOT_URL;  ?>/download.php?fname=business-hosted-apps/McAfee.pdf">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
					<div class="new-fix-height1 hidden-xs hidden-sm"></div>
				</div>
			...
			<div class="row sticky-padding" id="ffb">
				<div class="col-sm-7 copy-block">
					...
					<p class="block-content">
						...
						<a class="bstyle" href="<?php echo ROOT_URL;  ?>/download.php?fname=business-hosted-apps/FastForward_Onboarding.pdf">Download pdf <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt="PDF"/>  </a>      for details of all support plans.
					</p>
