	...
	<div class="container wrapper">
		<div class="padding-fix">
			<div class="row">
				...
				<img src="<?php echo ROOT_URL;  ?>/images/fpo3_2x.png" width="450" alt="FPO"/>
				</div>
			</div>
			...
			<div class="row sticky-padding" id="safe">
				...
				<div class="col-sm-6 copy-block">
					...
					<p class="block-images">
						<img src="<?php echo ROOT_URL;  ?>/images/bdb-logo3.jpg" alt="LOGO"/>
						<img src="<?php echo ROOT_URL;  ?>/images/bdb-logo1.jpg" alt="LOGO"/>
						<img src="<?php echo ROOT_URL;  ?>/images/bdb-logo2.jpg" alt="LOGO"/>
						<img src="<?php echo ROOT_URL;  ?>/images/bdb-logo4.jpg" alt="LOGO"/>
						<img src="<?php echo ROOT_URL;  ?>/images/bdb-logo5.jpg" alt="LOGO"/>
					</p>
				</div>
			...
			<div class="row sticky-padding" id="ffb">
				<div class="col-sm-7 copy-block">
					...
					<p class="block-content">
						...
						<a class="bstyle" href="download.php?fname=t.pdf">Download pdf <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt="PDF"/>  </a>      for details of all support plans.
					</p>
			...
			<div class="row sticky-padding"  id="pricing">
				<div class="col-sm-6 image-block hidden-xs">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo5_2x.png" width="360" alt=""/>
				</div>
				<div class="col-sm-6 copy-block">
					<h3 class="block-title">
