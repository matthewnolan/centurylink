		...
		<div class="padding-fix">
			<div class="row sticky-padding" id="email">
				...
				<div class="col-sm-6 image-block">
					<img src="<?php echo ROOT_URL;  ?>/images/new-business-fpo1.png" alt="MICROSOFT CLOUD"/>
				</div>
			</div>
			...
			<div class="row onboard3col">
				<div class="col-sm-4 ">
					...
					<div class="onboard-content new-business readmore">
						...
						<p><a href="<?php echo ROOT_URL;  ?>/pdf/business-hosted-apps/Microsoft_Hosted_Exchange.pdf" target="_blank" class="pdflink">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
					</div>
				</div>
				<div class="col-sm-4 ">
					<img src="<?php echo ROOT_URL;  ?>/images/sharepoint.png" alt="TALK"/>
					...
					<div class="onboard-content new-business readmore">
						...
						<p><a href="<?php echo ROOT_URL;  ?>/pdf/business-hosted-apps/Microsoft_Hosted_SharePoint.pdf" target="_blank" class="pdflink">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
				...
				<div class="col-sm-4 ">
					...
					<div class="onboard-content new-business readmore">
						...
						<span class="3dot">...</span><div class="details"></div>
							...
							<p><a href="<?php echo ROOT_URL;  ?>/pdf/business-hosted-apps/Microsoft_Hosted_Lync.pdf" target="_blank" class="pdflink">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
			...
			<div id="safe" class="row sticky-padding">
				<div class="col-sm-6 image-block hidden-xs">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo4_2x.png" width="380" alt=""/>
				</div>
				<div class="col-sm-6 copy-block">
			...
			<div class="row onboard3col">
				...
				<div class="onboard-content new-business readmore">
					...
					<p><a href="<?php echo ROOT_URL;  ?>/pdf/business-hosted-apps/McAfee.pdf" target="_blank" class="pdflink">Download</a> the details   <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt=""/></p>
					<div class="new-fix-height1 hidden-xs hidden-sm"></div>
				</div>
				...
				<div class="col-sm-4">
				<img src="<?php echo ROOT_URL;  ?>/images/mes-solution.png" alt="MESSAGE SOLUTIONS"/>
			...
			<div id="webmanagement" class="row sticky-padding">
				...
				<div class="col-sm-6 image-block">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo1_2x.png" width="450" alt=""/>
				</div>
			</div>
			<div class="block-seperator"></div>
			...
			<div class="row sticky-padding" id="ffb">
				<div class="col-sm-7 copy-block">
					...
					<p class="block-content">
						...
						<a class="bstyle" href="<?php echo ROOT_URL;  ?>/pdf/business-hosted-apps/FastForward_Onboarding.pdf">Download pdf <img src="<?php echo ROOT_URL;  ?>/images/pdf.png" alt="PDF"/>  </a>      for details of all support plans.
					</p>
					
				</div>
				<div class="col-sm-5 image-block">
					<img id="onboard-image" src="<?php echo ROOT_URL;  ?>/images/onboard_2x.png" width="374"  alt="ONBOARD"/>
				</div>
			</div>
