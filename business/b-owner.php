		...
		<div class="padding-fix">
			<div class="row">
				...
				<div class="col-sm-6 image-block">
					<img src="<?php echo ROOT_URL;  ?>/images/microsoft-cloud.png" alt="MICROSOFT CLOUD"/>
				</div>
			</div>
			...
			<div id="bhdb" class="row sticky-padding">
				<div class="col-sm-6 image-block hidden-xs">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo2_2x.png" width="394" alt=""/>
				</div>
				<div class="col-sm-6 copy-block">
					<p class="block-link">
					...
					<p class="block-more"> Backup data without a second thought. <a href="<?php echo ROOT_URL;  ?>/business/databackup">Start Now</a>
					</p>
