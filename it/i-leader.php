		...
		<div class="padding-fix">
			<div class="row">
				<div class="col-sm-7 copy-block">
					<p class="block-link">
						<a href="<?php echo ROOT_URL;  ?>/it/hosted-applications">CenturyLink Hosted Applications</a>
					</p>
				...
				<img src="<?php echo ROOT_URL;  ?>/images/fpo6_2x.png" width="303" alt="IFPO"/>
				</div>
			</div>
			...
			<div class="row sticky-padding" id="ihdb">
				<div class="col-sm-6 image-block hidden-xs">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo7_2x.png" width="432" alt=""/>
				</div>
				<div class="col-sm-6 copy-block">
					<p class="block-link">
						<a href="<?php echo ROOT_URL;  ?>/it/data-backup">CenturyLink Data Backup</a>
					</p>
					<h3 class="block-title">
					...
					<div class="testimonial hidden-sm hidden-xs">
						<div>
							<p class="first">
								"The management console is very clean&#8212;everything you need is right in front of you."
							</p>
