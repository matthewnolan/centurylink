				...
				<div class="secure-content">
					...
					<div class="row secure-detail">
						...
						<div class="col-sm-4 mid">
							<img class="visible-xs" src="<?php echo ROOT_URL;  ?>/images/network.jpg" alt=""/>
						...
						<div class="col-sm-4 last">
							<img class="visible-xs" src="<?php echo ROOT_URL;  ?>/images/sercurity.jpg" alt=""/>
		...
		<div class="padding-fix">
			...
			<div class="row">
				<div class="col-sm-6 image-block hidden-xs">
					<img src="<?php echo ROOT_URL;  ?>/images/fpo3_2x.png" width="450" alt=""/>
				</div>
