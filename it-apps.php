...
<div id="it-apps">
	...
	<div class="container wrapper">
		<div class="hero-container">
			<div class="hero-left">
				<img class="hero-label" src="images/i-hosted-label.png" alt="APPLICATIONS"/>
			...
			<div class="hero-right">
				<img class="icon" src="images/it-hosted-icon.png" alt="APPLICATIONS"/>
			</div>
		</div>
	</div>
</div>
...
<div class="mobile-hero visible-xs">
	<div class="main-hero">
		<img src="images/mobile-ihosted-hero.png" alt=""/>
	</div>
	<div class="container wrapper">
	...
	<div class="container wrapper">
		<div class="padding-fix">
			<p class="why-ctl-content">
				In today's business world, users need to access a wide variety of applications from a ton of different devices. Maintaining these applications, and supporting users, can eat up time and resources. That's where CenturyLink Hosted Apps can make a significant difference. We provide everything a business demands, from Microsoft essentials to email protection and archiving, as well as website management and security. Plus, you get comprehensive support from day one onboarding through day-to-day PC and network consultation from IT experts.
			</p>
			<div class="row ihosted-why-ctl">
			 	<div class="col-sm-4">
			 		...
			 		<ul>
				 		...
				 		<li>Compatible with all major OS environments&#8212;works with your server and end-point devices</li>
				 		<li>All end-users access a single, consistent application platform at the office and on the road</li>
			 		</ul>
			 	</div>
			 	<div class="col-sm-4">
			 	...
			 	<div class="col-sm-4">
			 		...
			 		<ul>
				 		...
				 		<li>Choice of support level to fit into your existing IT management model</li>
			 		</ul>
			 	</div>
			</div>
