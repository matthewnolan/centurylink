		...
		<div class="container wrapper">
			<div class="hero-container">
				...
				<div class="hero-right">
					<img class="people" src="images/itguy.png" alt="IT LEADER"/>
					<img class="icon" src="images/iticon1.png" alt="IT LEADER"/>
					<img class="icon1" src="images/iticon2.png" alt="IT LEADER"/>
