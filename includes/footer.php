		...
		<div class="padding-fix footer-content">
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<p class="social-icon">
						<a target="_blank" class="twitter" href="https://twitter.com/CenturyLinkBiz" title="Follow us on Twitter">
						<span class="fa-stack fa-lg">
							<i class="fa fa-circle fa-stack-2x"></i>
							<i class="fa icon-twitter fa-stack-1x fa-inverse"></i>
						</span>
						</a>
						<a target="_blank" class="facebook" href="https://www.facebook.com/CenturyLinkBusiness" title="Follow us on Facebook">
							<span class="fa-stack fa-lg">
								<i class="fa fa-circle fa-stack-2x"></i>
								<i class="fa fa-facebook fa-stack-1x fa-inverse"></i>
							</span>
						</a>
						<a target="_blank" class="google-plus" href="https://plus.google.com/u/0/117080893855557903730/posts" title="Follow us on Google Plus">
							<span class="fa-stack fa-lg">
								<i class="fa fa-circle fa-stack-2x"></i>
								<i class="fa fa-google-plus fa-stack-1x fa-inverse"></i>
							</span>
						</a>
						<a target="_blank" class="linkedin" href="http://www.linkedin.com/company/1434913?trk=tyah" title="Follow us on Linkedin">
							<span class="fa-stack fa-lg">
								<i class="fa fa-circle fa-stack-2x"></i>
			...
			*Offers available for a limited time. General&#8212;Services and offers not available everywhere. CenturyLink may change or cancel services or substitute similar services at its sole discretion without notice.
			...
			Offers may not be combined. Additional restrictions may apply.
			 ...
			 Service level agreements (SLAs)  in the terms and conditions describe customer's sole remedy for service quality or performance issues of any kind. All rates exclude taxes, fees and surcharges, as applicable.
			  Monthly recurring charges include listed features and service may have a bundle term commitment.  First Month Free Offer &mdash; New or existing savvisdirect customers making a new Software-as-a-Service (SaaS) purchase.
...
<script>
  ...
  ga('create', 'UA-27852033-4', 'centurylinkhostedservices.com');
  ga('send', 'pageview');
